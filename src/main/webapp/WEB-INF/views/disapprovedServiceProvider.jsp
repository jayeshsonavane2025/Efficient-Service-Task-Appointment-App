...
<link rel="icon" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQzEE0IUh5_no5tZxAnFktUX58Vnkbw_JWQA&usqp=CAU" type="image/x-icon" style="border-radius: 50%;">
     <title>
     BizExpert Hub 
    </title>
        ...
        <div class="navbar-collapse">
          ...
          >
            <ul class="nav" id="side-menu">
              ...
              <li>
                <a href="viewRequestServiceProvider" class="active"
                  ><i class="fa-solid fa-person-circle-check"></i>
                   Approve Service Provider</a
                >
              </li>
               <li>
                <a href="pendingServiceProvider" class="active"
                  ><i class="fa-solid fa-hourglass-half"></i>
                   Pending Service Provider</a
                >
              </li>
              
               <li>
                <a href="disapprovedServiceProvider" class="active"
                  ><i class="fa-solid fa-thumbs-down"></i>
                    Disapproved Service Provider</a
                >
              </li>
               <li>
                <a href="removeServiceProvider" class="active"
                  ><i class="fa-regular fa-xmark"></i>
                   Remove Service Provider</a
                >
              </li>
              ...
              <li>
                ...
                <ul class="nav nav-second-level collapse">
                  <li>
                   ...
                   <li>
                    <a href="#"><i class="fa-solid fa-plug"></i>&nbsp;Carpentry Services</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa-solid fa-palette"></i>&nbsp;Painting Services
</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa-solid fa-screwdriver-wrench"></i>&nbsp;Appliance Repair Services</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa-solid fa-house"></i>&nbsp;Roofing Services</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa-solid fa-house"></i>&nbsp;Flooring Services</a>
                  </li><li>
                    <a href="#"><i class="fa-solid fa-broom"></i>&nbsp;Cleaning Services
</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa-solid fa-bars"></i>&nbsp;Explore Many More Services
</a>
                  </li>
        ...
        <div class="header-left">
          ...
          <div class="logo">
            <a href="index">
              ...
              <h1><i class="fa-solid fa-handshake"></i> &nbsp;BizExpert Hub </h1>
...
<h2>Disapproved Service Provider List</h2>
...
<table border="1">
    ...
    <tbody>
        <% 
            List<ServiceProvider> serviceProviderList = (List<ServiceProvider>) request.getAttribute("serviceProvider");
        ...
        %>
            <tr>
                ...
                <td><%= serviceProvider.getsStatus() %></td>
               <!--   <td><a href="approved/<%= serviceProvider.getSid()%>">Approve </a></td>-->
                   <!--  <td><a href="pending/<%= serviceProvider.getSid()%>">Pending </a></td> -->
                   <td><a href="disapproved/<%= serviceProvider.getSid()%>"  style="display: inline-block; padding: 10px 15px; 
                   background-color: #28a745; color: #fff; text-decoration: none; border-radius: 5px;">Disapprove </a></td> 
            </tr>
        <% } %>
    </tbody>
</table>
