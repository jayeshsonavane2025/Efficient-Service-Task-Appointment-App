...
<%
    ...
    String nextSevenDaysDate = dateFormat.format(calendar.getTime());
        ...
        <tbody>
            <% for (Orders order : orders) { %>
                <% 
                    ...
                    // Calculate the difference in days between order date and today's date
                    long differenceInMillis = orderDate.getTime() - calendar.getTimeInMillis();
                    long differenceInDays = differenceInMillis / (1000 * 60 * 60 * 24);

                    // Check if order date falls within the next 7 days
                    if ("Approved".equals(order.getStatus()) && differenceInDays >= 0 && differenceInDays < 7) { 
                %>
                    <tr>
                        ...
                        <td style="display: inline-block; padding: 10px 15px; background-color: #28a745; color: #fff; text-decoration: none; border-radius: 5px;"><%= order.getStatus() %></td>
                    </tr>
                <% 
                    } 
                %>
