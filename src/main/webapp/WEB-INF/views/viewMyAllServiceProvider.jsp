...
<%@ page import="com.jayesh.model.Orders"%>
				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left"
					...
					<ul class="nav" id="side-menu">
						...
						<li><a href="#" class="active"><i
								...
								<li>
                <a href="viewMyAllServiceProvider" class="active"
                  ><i class="fa-solid fa-border-all"></i>
                  My All Services</a
                >
              </li>
						<li><a href="viewMyApprovedServiceProvider" class="active"><i
								class="fa-solid fa-person-circle-check"></i> Approve Services</a></li>
						<li><a href="viewMyPendingServiceProvider" class="active"><i
								class="fa-solid fa-hourglass-half"></i> Pending Services</a></li>


						<li><a href="viewMyDisapprovedServiceProvider" class="active"><i
								class="fa-solid fa-thumbs-down"></i> Disapproved Services</a></li>
						<li><a href="viewMyTodaysServiceProvider" class="active"><i
								class="fa-solid fa-calendar-check"></i> View Todays Orders</a></li>
						<li><a href="viewMy7DaysServiceProvider" class="active"><i
								class="fa-regular fa-calendar-check"></i> View Next 7 Days
								Orders</a></li>
									...
									<div class="user-name">
										...
										<p>
											<img src="./resources/images/img1.png" alt=""
												...
												class="profile_img" />&nbsp;
											<%= ((ServiceProvider) session.getAttribute("spObj")).getSname() %></p>
		...
		<div id="page-wrapper">
			...
			<div class="main-page">
				...
				<body>
					...
					<h2>My All Services Requests</h2>
...
%>
           ...
           <th>Service Provider Contact</th>
            -->
                 ...
                 <td><%= order.getServiceProviderContact() %></td>
                -->

								<td><%= order.getDate() %></td>
								<td><%= order.getTime() %></td>
								<td><%= order.getServiceTitle() %></td>
								<td><%= order.getServiceDescription() %></td>
								<td><%= order.getStatus() %></td>

								<td><a href="approvedService/<%= order.getOrderid()%>"
									style="display: inline-block; padding: 10px 15px; background-color: #28a745; color: #fff; text-decoration: none; border-radius: 5px;">Approve
								</a>
								<br><br>
								<a href="disapprovedService/<%= order.getOrderid()%>"
									style="display: inline-block; padding: 10px 15px; background-color: red; color: #fff; text-decoration: none; border-radius: 5px;">Disapprove
								</a>
								<br><br>
								<a href="pendingService/<%= order.getOrderid()%>"
									style="display: inline-block; padding: 10px 15px; background-color: gray; color: #fff; text-decoration: none; border-radius: 5px;">Pending
								</a>
								...
								<!-- Or use a button: -->
								<!--
                                        <a href="<%= request.getContextPath() %>/yourActionEndpoint?orderId=<%= order.getOrderid() %>">View Details</a>
                    
                    
                    <form action="<%= request.getContextPath() %>/yourActionEndpoint" method="get">
				...
				<h1 style="color: #333; padding: 20px; border-radius: 10px;">Our
					Services</h1>
...
" alt=""style="border-radius: 20px;">
          <br><br><br> -->
				<img
					src="https://th.bing.com/th/id/OIG3.z5903e44kBwcoFBDmVpQ?w=1024&h=1024&rs=1&pid=ImgDetMain"
					alt="" style="border-radius: 20px;"> <br> <br> <br>
				<img
					src="https://th.bing.com/th/id/OIG3.lwuL5u.v0vxk8bcTZ0gf?pid=ImgGn"
					alt="" style="border-radius: 20px;"> <br> <br> <br>
				<img
					src="https://th.bing.com/th/id/OIG3.K8X.vKK1neW691sURxX2?pid=ImgGn"
					alt="" style="border-radius: 20px;"> <br> <br> <br>
				<img
					src="https://mobisoftinfotech.com/resources/wp-content/uploads/2018/08/Banner.png"
					alt="" style="width: 1100px; height: 500px;"> <br> <br>
				<div class="row-one">
...
.image-container th, .image-container td {
	border: 1px solid #ddd;
	padding: 8px;
	text-align: left;
	background-color: #ffffff;
	/* Set the background color for all rows to white */
}
	...
	transform: translateX(0);
				...
				<div class="row">
					<div class="col-md-8 map widget-shadow">
						...
						<script src="./resources/js/jquery.vmap.sampledata.js"
							type="text/javascript"></script>
						<script src="./resources/js/jquery.vmap.world.js"
							type="text/javascript"></script>
