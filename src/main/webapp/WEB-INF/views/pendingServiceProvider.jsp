...
<h2>Pending Service Provider List</h2>
        ...
        %>
            <tr>
               ...
               <!--   <td><a href="approved/<%= serviceProvider.getSid()%>">Approve </a></td>-->
                 <td><a href="pending/<%= serviceProvider.getSid()%>"  style="display: inline-block; padding: 10px 15px; 
                 background-color: #28a745; color: #fff; text-decoration: none; border-radius: 5px;">Pending </a></td>   
            </tr>
        <% } %>
    </tbody>
</table>
