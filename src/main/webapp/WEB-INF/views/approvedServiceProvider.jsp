    ...
    <tbody>
        ...
        %>
            <tr>
                ...
                <td><a href="approved/<%= serviceProvider.getSid()%>"  style="display: inline-block; padding: 10px 15px; 
                background-color: #28a745; color: #fff; text-decoration: none; border-radius: 5px;">Approve </a></td>
