  ...
  <div class="login-block">
    <form action="afterUserLogin" method="post">
      ...
      <input
        ...
        name="upassword"
      />
      <input type="submit" value="Submit" class="button-73" /><br /> 
      <!-- <center>
        <a href="GetlocationOnMapPharmaRegister.html">
          &nbsp;Create Pharmacist Account
        </a>
      </center> -->
       
      <center>Not User?</center>
      <br />
       <a href="registerUser"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       Create User Account </a><br><br>
      <a href="adminLogin"> &nbsp;&nbsp;&nbsp;  Admin </a>
      <a href="serviceProviderLogin">&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
