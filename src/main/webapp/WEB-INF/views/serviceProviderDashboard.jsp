        ...
        <div class="navbar-collapse">
          ...
          >
            <ul class="nav" id="side-menu">
              ...
              <li>
                <a href="viewMyApprovedServiceProvider" class="active"
                  ><i class="fa-solid fa-person-circle-check"></i>
                   Approve Services</a
                >
              </li>
              <li>
                <a href="viewMyPendingServiceProvider" class="active"
               ...
               <li>
                <a href="viewMyDisapprovedServiceProvider" class="active"
                  ><i class="fa-solid fa-thumbs-down"></i>
                    Disapproved Services</a
                >
              </li>
               <li>
                <a href="viewMyTodaysServiceProvider" class="active"
                  ><i class="fa-solid fa-calendar-check"></i> 
                  View Todays Orders</a
                >
              </li>
              <li>
                <a href="viewMy7DaysServiceProvider" class="active"
                  ><i class="fa-regular fa-calendar-check"></i>
                  View Next 7 Days Orders</a
                >
              </li>
                ...
                >
                  <div class="profile_img">
                    ...
                    <div class="user-name">
                      ...
                      <p>  <img src="./resources/images/img1.png" alt="" style="width: 40px; height: 40px; border-radius: 50%;" class="profile_img"/>&nbsp;  <%= ((ServiceProvider) session.getAttribute("spObj")).getSname() %></p>
