	...
	<div class="main-content">
				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left"
					...
					<ul class="nav" id="side-menu">
						<li><a href="#" class="active"> <i
								class="fa fa-home nav_icon"></i> Dashboard
						</a></li>
					 ...
					 -->
						...
						<li><a href="scheduleService" class="active"><i
								class="fa-solid fa-clock"></i> Service Scheduler </a></li>

                        <li><a href="viewMyAllUser" class="active"><i class="fa-solid fa-border-all"></i> All Order Services
						</a></li>
						
						<li><a href="viewMyApprovedUser" class="active"><i
								class="fa-solid fa-person-circle-check"></i> Approved Order </a></li>
		...
		<div id="page-wrapper">
			...
			<div class="main-page">
                ...
                // Display row only if the status is "Approve"
            ...
            %>
							<tr>
								...
								<td
									style="display: inline-block; padding: 10px 15px; background-color: #28a745; color: #fff; text-decoration: none; border-radius: 5px;"><%= order.getStatus() %></td>
							</tr>
							<% 
                }
            } %>
